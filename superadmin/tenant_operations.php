...
$mechanixSuperadminContext = 'tenant_operations';
...
<head>
    ...
    <title>Tenant Operations - MECHANIX</title>
...
<div class="dashboard">
    <?php mechanix_superadmin_render_sidebar('tenant_ops', ['pending_registrations' => $pendingCount]); ?>
    ...
    <main class="dashboard-main sa-dashboard-main" id="main-content" tabindex="-1">
        <div class="dashboard-topbar">
            <div class="dashboard-title">
                ...
                <p>Live workspaces: subscription, access mode, feature toggles, and lifecycle tools in one place.</p>
            </div>
