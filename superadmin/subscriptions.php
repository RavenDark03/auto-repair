...
if (isset($_GET['status']) && !isset($_GET['subscription_status'])) {
    $_GET['subscription_status'] = $_GET['status'];
}
...
$mechanixSuperadminTenantPage = 'subscriptions.php';
$mechanixSuperadminContext = 'subscriptions';
...
<head>
    ...
    <title>Subscriptions - MECHANIX</title>
...
<div class="dashboard">
    <?php mechanix_superadmin_render_sidebar('subscriptions', ['pending_registrations' => $pendingCount]); ?>
    ...
    <main class="dashboard-main sa-dashboard-main" id="main-content" tabindex="-1">
        <div class="dashboard-topbar">
            <div class="dashboard-title">
                ...
                <h2>Subscriptions</h2>
                <p>Filter tenants by subscription state, then renew or edit terms on the same page.</p>
            </div>
