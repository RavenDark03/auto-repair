...
function api_job_select_sql(): string {
    return '
        ...
        j.status,
        a.appointment_date,
        a.concern AS appointment_concern,
        ...
        v.plate,
        v.year_model,
        COALESCE((SELECT u.full_name FROM users u WHERE u.user_id = j.mechanic_id AND u.tenant_id = j.tenant_id LIMIT 1), \'\') AS mechanic_name,
